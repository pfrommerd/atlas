...
quoted lam var          | BJV    | 0                | de Bruijn level              | static only; quoted lam-bound var
quoted dup var 0        | BJ0    | label            | de Bruijn level              | static only; quoted dup-bound var
quoted dup var 1        | BJ1    | label            | de Bruijn level              | static only; quoted dup-bound var
quoted lam              | LAM    | level+flags      | node: [body]                 | static only; level stored in EXT
